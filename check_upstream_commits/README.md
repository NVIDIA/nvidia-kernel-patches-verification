...
```
Usage: ./check_upstream_commits.sh [-b branch] [-u upstream/branch] [-q] <sha_list_file>
...
```
$ ./check_upstream_commits.sh commits 
...
```
$ ./check_upstream_commits.sh -q -b origin/linux grace_iov_patches_v04
Summary
_______
EXISTS : 605
REVIEW : 0
